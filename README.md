...
See [docs/security-notes.md](docs/security-notes.md). Key points:
...
See [docs/troubleshooting.md](docs/troubleshooting.md) for detailed remediation steps for common failures.
